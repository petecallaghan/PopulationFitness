...
class Epoch:
    def __init__(self, start_year, fitness_factor, kill_constant, environment_capacity=UNLIMITED_CAPACITY):
...
class Epochs:
    ...
    def addNextEpoch(self, start_year, fitness_factor, kill_constant, environment_capacity=UNLIMITED_CAPACITY):
        if (self.epochs):
